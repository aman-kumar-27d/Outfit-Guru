...
import { normalizeAnalysisPayload, normalizeEnhancementPayload } from "../lib/utils";
...
export default function OutfitAnalyzer({ detections, personRegions, selectedOccasion, analysisData, analysisLoading }: OutfitAnalyzerProps) {
  ...
  const normalizedAnalysis = analysisData ? normalizeAnalysisPayload(analysisData.analysis) : null;
  ...
  const handleGetEnhancement = async () => {
    ...
    try {
      ...
      if (normalizedAnalysis) {
        requestData.detections.analysis = normalizedAnalysis;
      }
            ...
            {analysisLoading ? (
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg p-6 border border-orange-100">
                  ...
                  <p className="text-gray-700 leading-relaxed">{normalizedAnalysis?.outfit_description}</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-lg p-6 border border-orange-100">
                    ...
                    <div className="space-y-2">
                      {(normalizedAnalysis?.positives || []).map((positive, index) => (
                  ...
                  <div className="bg-white rounded-lg p-6 border border-orange-100">
                    ...
                    <div className="space-y-2">
                      {(normalizedAnalysis?.negatives || []).length > 0 ? (
                        (normalizedAnalysis?.negatives || []).map((negative, index) => (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-lg p-6 border border-orange-100">
                    ...
                    <div className="space-y-2">
                      {(normalizedAnalysis?.lacking_items || []).length > 0 ? (
                        (normalizedAnalysis?.lacking_items || []).map((item, index) => (
                  ...
                  <div className="bg-white rounded-lg p-6 border border-orange-100">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {(normalizedAnalysis?.llm_tags || []).map((tag, index) => (
                        <span
                          key={index}
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl shadow-lg border border-purple-200 p-8 mb-8">
              ...
              {enhancementLoading ? (
                ...
                <div className="space-y-8">
                  {(() => {
                    const extractedData = normalizeEnhancementPayload(enhancementData.final_enhancement);
                    return (
                      <>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-4">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium capitalize ${extractedData.confidence_level === 'high' ? 'bg-green-100 text-green-800' :
                            ...
                            <div key={index} className="border border-purple-200 rounded-lg p-5 hover:border-purple-300 transition-all duration-200 hover:shadow-lg bg-gradient-to-br from-white to-purple-50/30">
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <span className={`text-xs px-2 py-1 rounded-full font-medium uppercase ${item.source === 'llm' ? 'bg-blue-100 text-blue-800' :
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <span className={`text-xs px-2 py-1 rounded-full font-medium ${item.source === 'llm' ? 'bg-red-100 text-red-800' :
